...
model = AutoModelForCausalLM.from_pretrained("checkpoints/sparknet-70m-v2/checkpoint-15259", config=model_cfg)
...
max_steps = 30_518 # override for second training pass
...
args = TrainingArguments(
    ...
    resume_from_checkpoint="checkpoints/sparknet-70m-v2",
    bf16=True, 
...
if __name__ == "__main__":
    trainer.train(resume_from_checkpoint="checkpoints/sparknet-70m-v2/checkpoint-15259")
    ...
    metadata = {
        ...
        "notes": "V3 | A second iteration of the same 1bil training tokens, for 2bil total learned tokens."
    }
